        ...
        >
          <div
            ...
            style={{
              ...
              boxShadow:
                "0 20px 50px rgba(0, 0, 0, 0.6), 0 0 30px rgba(255, 121, 0, 0.15), inset 0 1px 0 rgba(255, 255, 255, 0.1)",
            }}
          >
            ...
            <div className="flex items-center gap-3.5 sm:gap-4 relative z-10">
              ...
              <div className="relative shrink-0 w-20 h-20 sm:w-24 sm:h-24 rounded-xl overflow-hidden border border-orange-400/30 shadow-lg">
                ...
                <div className="absolute bottom-1 left-1 bg-orange-400/90 text-slate-950 font-extrabold text-[9px] uppercase px-1.5 py-0.5 rounded flex items-center gap-0.5">
              ...
              <div className="flex-1 min-w-0 pr-6 sm:pr-0">
                <div className="flex items-center gap-2 mb-1">
                  <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[10px] font-bold uppercase tracking-wider bg-orange-400/10 text-orange-300 border border-orange-400/30">
                ...
                <h3 className="text-sm sm:text-base font-extrabold text-white tracking-tight truncate group-hover:text-orange-300 transition-colors">
              ...
              <div className="flex flex-col sm:flex-row items-end sm:items-center gap-2 shrink-0">
                <Link
                  ...
                  style={{
                    background: "linear-gradient(135deg, #FF7900 0%, #E6C88B 50%, #B8933A 100%)",
